...
return [
    ...
    'notices' => [
        ...
        'node_created' => 'Novo node criado com sucesso. Você pode configurar automaticamente o daemon nesta máquina visitando a aba \'Configuration\'. <strong>Antes de adicionar qualquer servidor, você deve primeiro alocar pelo menos um endereço IP e porta.</strong>',
        'node_updated' => 'As informações do nó foram atualizadas. Se alguma configuração do daemon for alterada, você precisará reinicializá-lo para que as alterações tenham efeito.',
