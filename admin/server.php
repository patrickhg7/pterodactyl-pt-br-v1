...
return [
    'exceptions' => [
        ...
        'bad_variable' => 'Ocorreu um erro de validação com o :name variável.',
    ...
    'alerts' => [
        'startup_changed' => 'A configuração de inicialização para este servidor foi atualizada. Se o nest ou egg deste servidor foi alterado uma reinstalação irá ocorrer agora.',
        ...
        'transfer_not_viable' => 'O node que você selecionou não é viável para esta transferência.',
    ],
];
