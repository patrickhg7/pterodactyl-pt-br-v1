...
return [
    ...
    'two_factor' => [
        'button' => 'Configure a autenticação de 2 fatores',
        ...
        'enabled' => 'A autenticação de dois fatores foi habilitada em sua conta! A partir de agora, ao efetuar login, você será solicitado a fornecer o código gerado pelo seu dispositivo.',
